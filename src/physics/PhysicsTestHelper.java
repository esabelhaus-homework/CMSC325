...
//        floorGeometry.addControl(new RigidBodyControl(new PlaneCollisionShape(plane), 0));
    ...
    public static void createWeek4PhysicsWorld(Node rootNode, AssetManager assetManager, PhysicsSpace space) {
        AmbientLight light = new AmbientLight();
        light.setColor(ColorRGBA.LightGray);
        rootNode.addLight(light);

        Material material = new Material(assetManager, "Common/MatDefs/Misc/Unshaded.j3md");
        material.setColor("Color", new ColorRGBA(0,0,0,0.15f)); //Setting a transparent box
...
//        floorGeometry.addControl(new RigidBodyControl(new PlaneCollisionShape(plane), 0));
        floorGeometry.addControl(new RigidBodyControl(0));
        floorGeometry.setQueueBucket(Bucket.Transparent);
        rootNode.attachChild(floorGeometry);
        space.add(floorGeometry);
    }
